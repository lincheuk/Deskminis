...
> ⚠️ **已被 `2026-09-10-session-handoff.md` 取代，勿据此开局。**
> 本版 §4 波史停在 W 波；§5 仍写着旧组件树「待删」——**T6 已于 2026-09-10 删净**；
> §6「T6 开工前的补充事实」有两句已失效（`main.ts` 注释、「40 个测试文件」）。
> 本版是补丁摞出来的，新版是整合过的，一次读完就能开局。
