...
状态：**已落地**（用户 2026-08-20 确认全稿含 4b 修订；G1 c4691a5 → G2 477b4c1 → G3 0feac61 →
G4 8824ed4，四步全过审；装→用端到端闭环经云端全链路实证——市场装的 MCP 真启动、真调用、
真过权限卡。执行期偏离与观察项见 PROJECT_NOTES G1–G4 审核记录。）
